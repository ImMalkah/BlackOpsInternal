...
namespace FeatureManager
{
    ...
    void DrawEntityListTab()
    {
        ...
        // 2. Display Entity List Table
        ImGui::TextColored(ImVec4(0.2f, 1.0f, 0.5f, 1.0f), "Active Entities (cg_entities Array)");
        
        if (ImGui::BeginTable("EntityListTable", 7, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg | ImGuiTableFlags_Resizable))
        {
